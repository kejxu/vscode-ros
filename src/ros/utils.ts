...
/**
 * execute a setup file and return the new environment
 */
...
/**
 * get installed ROS distributions
 */
...
/**
 * get a map of package names to paths
 */
export function getPackages(): Promise<Map<string, string>> {
...
/**
 * get include dirs using `catkin_find`
 */
...
/**
 * create and show a ROS-sourced terminal
 */
